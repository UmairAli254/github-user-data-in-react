...
const Card = (props) => {
    // console.log(props);
    return (
        <div className="col-10 col-md-4 mt-2 ml-2">
            <div className="card p-2">
                <div className="d-flex align-items-center">
                    <div className="image"> <img src={props.Img} className="rounded" width="155" /> </div>
                    <div className="ml-3 w-100">
                        <h4 className="mb-0 mt-0 textLeft">{props.Name}</h4>
                        {/* <span className="text-left">Top rated user from github</span> */}
